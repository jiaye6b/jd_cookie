...
const JD_UA = 'Mozilla/5.0 (iPhone; U; CPU iPhone OS 6_3_2 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/9.1.8 Mobile/8H7 Safari/6533.18.5 UCBrowser/13.4.2.1698';
const app = express();
app.use(cors());
