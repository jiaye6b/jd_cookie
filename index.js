...
const JD_UA = `Mozilla/5.0 (iPhone; CPU iPhone OS 12_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 QQ/8.0.6.432 V1_IPH_SQ_8.0.6_1_APP_A Pixel/1242 Core/WKWebView Device/Apple(iPhone XS Max) NetType/WIFI QBWebViewType/1 WKType/1`
const app = express();
app.use(cors());
